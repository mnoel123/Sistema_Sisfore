...
<div class="container">
  <main class="mt-3">
   ...
   <a href="{{ route('Preguntas.create') }}" class="btn btn-primary mb-3">Crear pregunta</a>
    ...
    <table id="mitabla" class="table table-striped">
      ...
      <tbody>
        ...
        <tr>
          ...
          <td>
            <a href="{{ route('Preguntas.edit', $pregunta['id']) }}" class="btn btn-warning btn-sm custom-btn" ><i class="fas fa-edit"></i>Editar</a>
            <form action="{{ route('Preguntas.destroy', $pregunta['id']) }}" method="POST" style="display: inline-block;">
              @csrf
              @method('DELETE')
